...
namespace ScheduleCalendar_V2.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeId,EmployeeName,EmployeeDateOfHire")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeId,EmployeeName,EmployeeDateOfHire")] Employee employee)
        {
            if (ModelState.IsValid)
            {
